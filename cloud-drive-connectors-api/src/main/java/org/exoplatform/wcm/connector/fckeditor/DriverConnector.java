...
//    }
  ...
  private List<DriveData> getDriversByUserId(String userId) throws Exception {
    ManageDriveService driveService = ExoContainerContext.getService(ManageDriveService.class);
  ...
  private Node getTargetNode(Session session, String path) throws Exception {
    ...
    if (linkManager_ == null) {
      linkManager_ = ExoContainerContext.getService(LinkManager.class);
    }
    if (nodeFinder_ == null) {
      nodeFinder_ = ExoContainerContext.getService(NodeFinder.class);
    }
  ...
  public String getGroupLabel(String name) {
    try {
      RepositoryService repoService = ExoContainerContext.getService(RepositoryService.class);
      NodeHierarchyCreator nodeHierarchyCreator = ExoContainerContext.getService(NodeHierarchyCreator.class);
      String groupPath = nodeHierarchyCreator.getJcrPath(BasePath.CMS_GROUPS_PATH);
  ...
  public static Element createFileElement(Document document,
    ...
    if (linkManager == null) {
      linkManager = ExoContainerContext.getService(LinkManager.class);
    }
